...
class _ScoreboardPageState extends State<ScoreboardPage> {
  ...
  Widget build(BuildContext context) {
    final List<Participant> participants = List<Participant>.from(
        Provider.of<ParticipantsViewModel>(context).participants);
            ...
            child: Row(
              children: <Widget>[
                ...
                MaterialButton(
                  ...
                  onPressed: () =>
                      Provider.of<ParticipantsViewModel>(context, listen: false)
                          .decrementScore(participants[index]),
                ),
                MaterialButton(
                  child: Icon(
                  ...
                  onPressed: () =>
                      Provider.of<ParticipantsViewModel>(context, listen: false)
                          .incrementScore(participants[index]),
                ),
              ],
            ),
          );
